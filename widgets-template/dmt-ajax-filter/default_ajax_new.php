 ...
 **/
global $wp_query;
$post_count = dmt_option( 'product_count', 12 );
...
$per_page               = ( isset( $post_count ) && $post_count ) ? (int) $post_count : 12;
...
include( DMT_WIDGET_TEMPLATE_PATH . 'dmt-ajax-filter/products.php' );
...
ob_start();
include( DMT_WIDGET_TEMPLATE_PATH . 'dmt-ajax-filter/result-count.php' );
$result_count         = ob_get_contents();
$result->result_count = $result_count;
ob_end_clean();

ob_start();
include( DMT_WIDGET_TEMPLATE_PATH . 'dmt-ajax-filter/filter-new.php' );
$left_nav         = ob_get_contents();
$result->left_nav = $left_nav;
ob_end_clean();

ob_start();
include( DMT_WIDGET_TEMPLATE_PATH . 'dmt-ajax-filter/title.php' );
$title                = ob_get_contents();
$result->result_title = $title;
ob_end_clean();

ob_start();
include( DMT_WIDGET_TEMPLATE_PATH . 'dmt-ajax-filter/pagination.php' );
$pagination         = ob_get_contents();
$result->pagination = $pagination;
ob_end_clean();

ob_start();
include( DMT_WIDGET_TEMPLATE_PATH . 'dmt-ajax-filter/breadcrumb.php' );
