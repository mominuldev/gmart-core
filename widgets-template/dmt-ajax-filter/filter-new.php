<?php
	...
	if($select_filter == 'price'){
		$j++;
	}
if($j>0){
?>
<div  class="widget-price-filter dmt-filter-ajax grid-<?php echo esc_attr($j); ?>">
	<form id="dmt_form_filter_product">
	<?php
	//Filter Price
	if($select_filter == 'price')
		woocommerce_filter_price($chosen_attributes,$default_min_price,$default_max_price);
	//list atribute
	if($attribute)
		woocommerce_filter_atribute($attribute,$tax_query,$meta_query,$chosen_attributes,$relation,$showcount);
	?>
	</form>
</div>
<?php } ?>
