(function ($, _) {
    var RazziProductsFilterWidget = function () {
        ...
        $(document.body)
            ...
            .on('dmt_products_filter_change', {widget: self}, self.instantSearch)
            .on('dmt_products_filter_request_success', self.updateURL)
            .on('dmt_products_filter_request_success', {widget: self}, self.updateForm)
            .on('dmt_products_filter_widget_updated', {widget: self}, self.initDropdowns)
            .on('dmt_products_filter_widget_updated', {widget: self}, self.initSliders);
    };
    ...
    RazziProductsFilterWidget.prototype.toggleItem = function (event) {
        ...
        $(document.body).trigger('dmt_products_filter_change', [form]);
    }
    ...
    RazziProductsFilterWidget.prototype.resetFilters = function () {
        ...
        $form.trigger('submit');
        $(document.body).trigger('dmt_products_filter_reseted');
    }
    ...
    RazziProductsFilterWidget.prototype.clearFilters = function () {
        ...
        $form.trigger('submit');
        $(document.body).trigger('dmt_products_filter_cleared');
    }
    ...
    RazziProductsFilterWidget.prototype.updateForm = function (event, response, url, form) {
        ...
        $(document.body).trigger('dmt_products_filter_widget_updated', [form]);
    }
    ...
    RazziProductsFilterWidget.prototype.sendAjaxRequest = function (form) {
        ...
        $container.addClass('loading').append('<li class="gmart-posts__loading"><span class="gmart-loading"></span> </li>');

        $(document.body).trigger('dmt_products_filter_before_send_request', $container);
        ...
        self.ajax = $.get(url, function (response) {
            ...
            if (!$products.length) {
                ...
                $products.find('li.product').addClass('animated gmartFadeInUp');

                $(document.body).trigger('dmt_products_loaded', [$products.children(), false]); // appended = false
            }

            $form.removeClass('filtering');
            $(document.body).trigger('dmt_products_filter_request_success', [response, url, form]);
        });
    }
