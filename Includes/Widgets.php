...
//		extract( $instance );
//
//		if ( $tpl = $this->getTemplatePath( 'default-new' ) ) {
...
//	}
//
//	protected function getTemplatePath( $tpl = 'default-new', $type = '' ) {
//		$file = '/' . $tpl . $type . '.php';
...
//		}
//
//		return $tpl == 'default-new' ? false : $this->getTemplatePath( 'default-new', $type );
//	}
//
//	/**
