<div id="navbar" class="navbar">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="dmt-admin-nav">
                    <ul>
                        <?php
                            $admin_nav_first_item_class = ( !isset( $_GET['action'] ) && $_GET['page'] == 'gmart-core' ) ? 'active' : '';

                            $admin_nav_items = array(
                                'default' => array(
                                    'title' => 'Dmt',
                                    'url'   => admin_url( 'admin.php?page=dmt_core' ),
                                    'target' => '_self',
                                ),
                                'banner' => array(
                                    'title' => 'Documentation',
                                    'url'   => 'https://themeboxr.com/product/wpdmt-university-alumni-wordpress-theme/',
                                    'target' => '_blank',
                                ),
                                'section_title' => array(
                                    'title' => 'Support',
