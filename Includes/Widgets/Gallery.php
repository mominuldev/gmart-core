...
class Gallery extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dmt Gallery', 'gmart-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_gallery',
			[
				'label' => esc_html__( 'Image Gallery', 'gmart-core' ),
			]
		);
		...
		$this->add_control(
			'wp_gallery',
			[
				'label' => esc_html__( 'Add Images', 'gmart-core' ),
		...
		$this->add_control(
			'gallery_link',
			[
				'label' => esc_html__( 'Link', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'file',
				'options' => [
					'file' => esc_html__( 'Media File', 'gmart-core' ),
//					'attachment' => esc_html__( 'Attachment Page', 'gmart-core' ),
					'none' => esc_html__( 'None', 'gmart-core' ),
				],
			]
		);
		...
		$this->add_control(
			'open_lightbox',
			[
				'label' => esc_html__( 'Lightbox', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default' => esc_html__( 'Default', 'gmart-core' ),
					'yes' => esc_html__( 'Yes', 'gmart-core' ),
					'no' => esc_html__( 'No', 'gmart-core' ),
				],
				'condition' => [
					'gallery_link' => 'file',
				],
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'gmart-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Images', 'gmart-core' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => esc_html__( 'Default', 'gmart-core' ),
					'custom' => esc_html__( 'Custom', 'gmart-core' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Image Spacing', 'gmart-core' ),
		...
		$this->start_controls_section(
			'section_caption',
			[
				'label' => esc_html__( 'Caption', 'gmart-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'' => esc_html__( 'Show', 'gmart-core' ),
					'none' => esc_html__( 'Hide', 'gmart-core' ),
				],
				'selectors' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'shortcode', 'dmt-overlay', 'dmt-overlay' );
