...
class Tabs extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'tab_label' => __( 'Product', 'gmart-core' ),
					],
					[
						'tab_label' => __( 'Customer', 'gmart-core' ),
					],
					[
						'tab_label' => __( 'Pricing', 'gmart-core' ),
					],
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => 'center',
				'selectors' => [
					'{{WRAPPER}} .dmt-dynamic-tabs-nav' => 'text-align: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'tab_wrapper' ) ?>>
			<div class="dmt-tabs-nav-wrapper">
			...
			<div id="dmt-dynamic-tabs-content" class="ollix-dynamic-tabs-wrapper">
