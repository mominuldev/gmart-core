...
class ImageCarousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dmt Image Carousel', 'gmart-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Image Carousel', 'gmart-core' ),
			]
		);
		...
		$repeater->add_control(
			'image-three',
			[
				'label'   => __( 'Image Three', 'gmart-core' ),
				'type'    => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => __( 'Brand Name', 'gmart-core' ),
				'placeholder' => __( 'Type brand name here', 'gmart-core' ),
			]
		);
		...
		$this->add_control(
			'images',
			[
				'label'       => __( 'Image List', 'gmart-core' ),
				...
				'default'     => [
					[
						...
						'title-one'  => __( 'Quiet slide -1', 'gmart-core' ),
						'image-two' => [
							'url' => Utils::get_placeholder_image_src(),
						],
						'title-two'  => __( 'Quiet slide -2', 'gmart-core' ),
						'image-three' => [
							'url' => Utils::get_placeholder_image_src(),
						],
						'title-three'  => __( 'Quiet slide -3', 'gmart-core' )
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .dmt-image-carousel-title' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dmt-image-carousel-title',
			]
		);
		...
		$this->add_responsive_control(
			'title_spacing',
			[
				'label'      => __( 'Title Spacing', 'gmart-core' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .dmt-image-carousel-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section( 'progress_bar_section', [
			'label' => esc_html__( 'Progress Bar', 'gmart-core' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		] );
		...
		$this->add_control(
			'progress_bar_color',
			[
				'label'     => __( 'Progress Bar Color', 'gmart-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'progress_bar_height',
			[
				'label'     => __( 'Progress Bar Height', 'gmart-core' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 4,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Active Progress Bar Color', 'gmart-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Progress Bar Border Radius', 'gmart-core' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 0,
				'selectors' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'dmt-image-carousel-wrapper' );
							...
							<div class="swiper-slide">
								<div class="row">
									<div class="col-lg-3 align-self-end">
										<div class="dmt-slider-image">
											<?php if( ! empty( $item['title-one'] )) : ?>
												<h3 class="dmt-image-carousel-title"><?php echo esc_html( $item['title-one'] ); ?></h3>
											<?php endif; ?>
									...
									<div class="col-lg-6">
										<div class="dmt-slider-image sbt-slider-image--center">
											<?php if( ! empty( $item['title-two'] )) : ?>
												<h3 class="dmt-image-carousel-title"><?php echo esc_html( $item['title-two'] ); ?></h3>
											<?php endif; ?>
									...
									<div class="col-lg-3">
										<div class="dmt-slider-image">
											<?php if( ! empty( $item['title-three'] )) : ?>
												<h3 class="dmt-image-carousel-title"><?php echo esc_html( $item['title-three'] ); ?></h3>
											<?php endif; ?>
