...
class FancyHeading extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => sprintf( __( '<div style="font-style:normal">If you want to use highlighted text use shortcode. Example:<br/><br/> <span style="font-weight:bold">[ld_highlight]</span> Your Text <span style="font-weight:bold">[/ld_highlight]</span></div>', 'gmart-core' ) ),
				'separator' => 'after',
		...
		$this->add_control(
			'tag',
			[
				'label' => esc_html__( 'Element Tag', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			'add_gradient',
			[
				'label' => __( 'Gradient And Mask Image?', 'gmart-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gmart-core' ),
				'label_off' => __( 'Off', 'gmart-core' ),
				'return_value' => 'yes',
				'default' => ''
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'color2',
				'label' => __( 'Fancy Heading Background', 'gmart-core' ),
		...
		$this->add_control(
			'use_inheritance',
			[
				'label' => __( 'Inherit font styles?', 'gmart-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gmart-core' ),
				'label_off' => __( 'Off', 'gmart-core' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'enable_split',
			[
				'label' => __( 'Enable text split?', 'gmart-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gmart-core' ),
				'label_off' => __( 'Off', 'gmart-core' ),
				'return_value' => 'true',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'words' => __( 'Words', 'gmart-core' ),
					'chars, words' => __( 'Characters', 'gmart-core' ),
				],
				'condition' => [
					'enable_split' => 'true',
				],
		...
		$this->add_control(
			'use_mask',
			[
				'label' => __( 'Enabled mask?', 'gmart-core' ),
				'description' => __('Check to enable mask on title to use it in animation', 'gmart-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gmart-core' ),
				'label_off' => __( 'Off', 'gmart-core' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'enable_txt_rotator',
			[
				'label' => __( 'Enable text rotator?', 'gmart-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gmart-core' ),
				'label_off' => __( 'Off', 'gmart-core' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'rotator_type',
			[
				'label' => __( 'Animation type', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'Slide', 'gmart-core' ),
					'basic' => __( 'Basic', 'gmart-core' ),
					'list' => __( 'List', 'gmart-core' ),
				],
				'condition' => array(
		...
		$this->add_control(
			'rotator_delay', [
				'label' => __( 'Words stay time', 'gmart-core' ),
				'description' => __( 'Stay time for each word in seconds. Default is 2 seconds', 'gmart-core' ),
				'type' => Controls_Manager::TEXT,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
				),
		...
		$this->add_control(
			'word_colors',
			[
				'label' => __( 'Words color', 'gmart-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
				),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Active color start', 'gmart-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
					'rotator_type' => 'list',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Active color stop', 'gmart-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'enable_txt_rotator' => 'yes',
					'rotator_type' => 'list',
		...
		$repeater->add_control(
			'word', [
				'label' => __( 'Title word', 'gmart-core' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'items',
			[
				'label' => __( 'Text rotator words', 'gmart-core' ),
				'type' => Controls_Manager::REPEATER,
		...
		$this->start_controls_section(
			'white_space_section',
			[
				'label' => __( 'White Space', 'gmart-core' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'whitespace',
			[
				'label' => __( 'Whitespace', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'Normal', 'gmart-core' ),
					'ws-nowrap' => __( 'Nowrap', 'gmart-core' ),
				]
			]
		);
		...
		$this->add_control(
			'highlight_type',
			[
				'label' => __( 'Type', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'lqd-highlight-underline',
				'options' => [
					''  => __( 'None', 'gmart-core' ),
					'lqd-highlight-underline'  => __( 'Classic', 'gmart-core' ),
					'lqd-highlight-custom-underline' => __( 'Custom 1', 'gmart-core' ),
					'lqd-highlight-custom-underline lqd-highlight-custom-underline-alt' => __( 'Custom 2', 'gmart-core' ),
					'lqd-highlight-custom lqd-highlight-custom-3' => __( 'Custom 3', 'gmart-core' ),
					'lqd-highlight-custom lqd-highlight-custom-4' => __( 'Custom 4', 'gmart-core' ),
					'lqd-highlight-custom lqd-highlight-custom-5' => __( 'Custom 5', 'gmart-core' ),
				],
			]
		);
		...
		$this->add_control(
			'highlight_animation',
			[
				'label' => __( 'Animation', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'lqd-highlight-grow-left',
				'options' => [
					'lqd-highlight-grow-left'  => __( 'Grow From Left', 'gmart-core' ),
					'lqd-highlight-grow-bottom' => __( 'Grow From Bottom', 'gmart-core' ),
					'lqd-highlight-fadein' => __( 'Fade In', 'gmart-core' ),
				],
				'condition' => array(
		...
		$this->add_control(
			...
			[
				'label' => __( 'Fill Text On Hover?', 'gmart-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gmart-core' ),
				'label_off' => __( 'Off', 'gmart-core' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'highlight_color',
			[
				'label' => __( 'Highlight Color', 'gmart-core' ),
				'type' => Controls_Manager::COLOR,
				'condition' => array(
					'highlight_type' => 'lqd-highlight-underline',
				),
		...
		$this->add_responsive_control(
			'highlight_offset',
			[
				'label' => __( 'Bottom Offset', 'gmart-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => '0em',
				'placeholder' => __( 'Add line bottom offset, for ex -10px', 'gmart-core' ),
				'condition' => array(
					'highlight_type!' => '',
				),
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Left Offset', 'gmart-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => '0em',
				'placeholder' => __( 'Add line left offset, for ex -10px', 'gmart-core' ),
				'condition' => array(
					'highlight_type!' => '',
				),
				'selectors' => [
		...
		$this->add_responsive_control(
			'highlight_roudness',
			[
				'label' => __( 'Roundness', 'gmart-core' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Add line roudness in px, for ex 5px', 'gmart-core' ),
				'condition' => array(
					'highlight_type' => 'lqd-highlight-underline',
				),
				'selectors' => [
		...
		$this->add_control(
			'hover_text_outline',
			[
				'label' => __( 'Outline Text', 'gmart-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'gmart-core' ),
				'label_off' => __( 'Off', 'gmart-core' ),
		...
		$this->add_control(
			'outline_appearance',
			[
				'label' => __( 'Appearance', 'gmart-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => __( 'None', 'gmart-core' ),
					'ld-fh-outline-static' => __( 'Default', 'gmart-core' ),
					'ld-fh-outline' => __( 'On Hover', 'gmart-core' ),
				],
				'condition' => array(
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => '2px',
				'placeholder' => __( 'Set hover text outline width in px. for ex. 5px', 'gmart-core' ),
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Vertical Text', 'gmart-core' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			'ld_inner_margin',
			[
				'label' => __( 'Heading Margin', 'gmart-core' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'default' => [
					'bottom' => '0.5',
		...
		$this->add_responsive_control(
			'ld_inner_padding',
			[
				'label' => __( 'Heading Padding', 'gmart-core' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sticky Color', 'gmart-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Colors Over Light Rows', 'gmart-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Colors Over Dark Rows', 'gmart-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		<div id="<?php echo esc_attr( $id ); ?>" class="<?php echo Dmt_Helper::sanitize_html_classes( $classes ); ?>">
	...
	protected function get_data_opts() {
		...
		return Dmt_Helper::html_attributes( $opts );
