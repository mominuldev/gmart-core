<div class="dmt-icon-box style-three">
    ...
    <div class="box-content">
	    ...
	    <?php if ( ! empty( $settings['button_text'] ) ) : ?>
			<a href="<?php echo esc_url( $settings['btn_link']['url'] ); ?>" class="dmt-btn-link"><?php echo esc_html( $settings['button_text'] ); ?> <i class="ei ei-arrow_right"></i></a>
	    <?php endif; ?>
