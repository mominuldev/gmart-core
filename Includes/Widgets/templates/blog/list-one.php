<div class="gotox__post-list gotox__post-list--<?php echo esc_attr($settings['layout']); ?>">
	<?php if ( has_post_thumbnail() ): ?>
		<div class="gotox__feature-image">
			<?php the_post_thumbnail( 'gotox_blog_grid_400x182', array( 'class' => 'img-fluid' ) ) ?>
			<div class="gotox__post-list-title-wrapper">
				...
				<?php if ( 'yes' == $settings['category_show'] ) : ?>
					<div class="gotox__meta-category-wrapper">
						...
						if ( $terms && ! is_wp_error( $terms ) ) :
							foreach ( $terms as $term ) {
								$cat_temp .= '<a href="' . get_category_link( $term->term_id ) . '" class="gotox__blog-meta-category" rel="category tag">'. $icon . esc_html( $term->name ) . '</a>';
							}
						endif;
	...
	<div class="gotox__blog-content">
		...
		<?php if ( 'yes' == $settings['meta_show'] ) : ?>
			<div class="gotox__post-list--meta">
				<div class="gotox-post__author-meta">
				...
				<div class="gotox-post__date-meta">
					...
					<?php Dmt_Theme_Helper::gotox_posted_on(); ?>
				</div>
			</div>
		<?php endif; ?>
	</div>
