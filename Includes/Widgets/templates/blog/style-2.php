		...
		<div class="feature-image">
			<?php if (has_post_thumbnail()): ?>
				<a href="<?php echo the_permalink(); ?>">
					<?php the_post_thumbnail('dmt_blog_grid_370x400', array('class' => 'img-fluid')) ?>
				</a>
			<?php endif; ?>
			...
			<div class="entry-content">
				<div class="author vcard">
					<a class="post-author" href="blog-single.html">
						<?php echo Dmt_Theme_Helper::gotox_posted_author_avatar(); ?>
					</a>
				</div>
			...
			<a href="<?php the_permalink(); ?>" class="read-more-btn"><?php esc_html_e('Read More ', 'gmart-core') ?>
