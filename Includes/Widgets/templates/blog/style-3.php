    ...
    <div class="post-grid style-four">
		<?php if ( has_post_thumbnail() ): ?>
            <div class="feature-image">
                <a href="<?php echo the_permalink(); ?>">
					<?php the_post_thumbnail( 'dmt_blog_grid_520x446', array( 'class' => 'img-fluid' ) ) ?>
                </a>
        ...
        <div class="blog-content">
			<?php if ( 'yes' == $settings['meta_show'] ) : ?>
                <ul class="post-meta">
                    <li class="author-simple">
						...
						<?php echo Dmt_Theme_Helper::dmt_posted_by(); ?>
                    </li>
                    <li class="meta-date">
            ...
            <div class="entry-header">
                ...
                <a href="<?php the_permalink(); ?>" class="read_more_btn"><?php esc_html_e( 'Read More ', 'gmart-core' ) ?></a>
            </div>
        </div>
    </div>
</div>
