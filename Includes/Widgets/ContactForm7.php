...
class ContactForm7 extends Widget_Base {
	...
	public function get_name() {
		return 'dmt-contact-form';
	}


	public function get_title() {
		return __( 'Dmt Contact Form 7', 'gmart-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'form_title',
			[
				'label'       => __( 'Form Title', 'gmart-core' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'description' => __( '(Optional) Title to search if no ID selected or cannot find by ID.', 'gmart-core' ),
				'label_block' => true
			]
		);
		...
		$this->add_control(
			'f_id',
			[
				'label'   => __( 'Select a form', 'gmart-core' ),
				'type'    => Controls_Manager::SELECT,
				'options' => \Dmt_Helper::dmt_get_contact_form7_forms(),
				'default' => '1'
		...
		$this->add_control(
			'title_spacing',
			[
				'label'      => __( 'Spacing (Margin Bottom)', 'gmart-core' ),
		...
		$this->add_control(
			'textarea_height',
			[
				'label'      => __( 'Textarea Height', 'gmart-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
