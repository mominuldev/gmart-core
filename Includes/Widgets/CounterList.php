...
class CounterList extends Widget_Base {
	...
	public function get_title() {
		return __( 'Gotex Counter List', 'gmart-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'        => '3',
				'options'        => [
					'3' => __( '4 Column', 'gmart-core' ),
					'4' => __( '3 Column', 'gmart-core' ),
					'6' => __( '2 Column', 'gmart-core' ),
				],
				'selectors'      => [
					'{{WRAPPER}} .gotox-counter-list' => 'width: calc(100% / {{VALUE}});',
				],
			]
		);
		...
		$this->add_control( 'counter_list', [
			'label'   => __( 'Counter List', 'gmart-core' ),
			...
			'default' => [
				[
					...
					'count_number'     => __( '20', 'gmart-core' ),
					'suffix_after'     => 'k',
					'count_title'      => __( 'Project Completed', 'gmart-core' ),
				],
				[
					'icon_type'        => 'icon',
					'selected_icon'    => [
					...
					'count_number'     => __( '8', 'gmart-core' ),
					'suffix_after'     => 'k',
					'count_title'      => __( 'Team Member', 'gmart-core' ),
				],
				[
					'icon_type'        => 'icon',
					'selected_icon'    => [
					...
					'suffix_after'     => '+',
					'count_number'     => __( '500', 'gmart-core' ),
					'count_title'      => __( 'Awards Winning', 'gmart-core' ),
				],
				[
					'icon_type'        => 'icon',
					'selected_icon'    => [
					...
					'suffix_after'     => '+',
					'count_number'     => __( '40', 'gmart-core' ),
					'count_title'      => __( 'Happy Customer', 'gmart-core' ),
				],
			],
			...
			<div class="dmt-counter">
				...
				<div class="dmt-counter__content">
					...
					<?php if ( ! empty( $item['count_title'] ) ) : ?>
						<p class="dmt-counter__title"><?php echo $item['count_title']; ?></p>
					<?php endif; ?>
				</div>
			</div>
			</div>
