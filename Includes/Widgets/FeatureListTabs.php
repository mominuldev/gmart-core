...
class FeatureListTabs extends Widget_Base
{
	...
	{
		return 'dmt-feature-list-tabs';
	}


	public function get_title()
	{
		return __('Dmt Feature Tabs ', 'gmart-core');
	}
		...
		if ($settings['feature_lists']) { ?>
			<div class="dmt-feature">
				<div class="row align-items-center">
					<div class="col-lg-6 dmt-order-md">
					...
					<div class="col-lg-6">
						<div class="dmt-feature__image-wrapper">
						<?php foreach ($settings['feature_lists'] as $index => $item) { ?>
							<div class="dmt-feature__image" id="<?php echo esc_attr( $id_int . '-' . $index ); ?>">
