...
class LogoCarousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dmt Logo Carousel', 'gmart-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_logo',
			[
				'label' => esc_html__( 'Logo Carousel', 'gmart-core' ),
			]
		);
		...
		$this->add_control(
			'marquee',
			[
				'label'        => esc_html__( 'Marquee', 'gmart-core' ),
		...
		$this->add_control(
			'rtl_mode',
			[
				'label'        => esc_html__( 'RTL On/Off', 'gmart-core' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'On', 'gmart-core' ),
				'label_off'    => esc_html__( 'Off', 'gmart-core' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'perview',
			[
				'label'   => __( 'Desktop Per View', 'gmart-core' ),
		...
		$this->add_control(
			'perview_tablet',
			[
				'label'   => __( 'Tablet Per View', 'gmart-core' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 3,
			]
		);
		...
		$this->add_control(
			'perview_mobile',
			[
				'label'   => __( 'Mobile Per View', 'gmart-core' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 2,
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'dmt-logo-carousel' );

		if ( $settings['layout'] == 'style-two' ) {
			$this->add_render_attribute( 'wrapper', 'class', 'dmt-client-logo--marquee' );
							...
							<div class="swiper-slide">
								<div class="client-logo text-center" title="<?php echo esc_attr( $logo['name'] ); ?>">
									<?php if ( ! empty( $img ) ): ?>
										...
										<?php endif; ?>
										<img src="<?php echo esc_url( $img ) ?>" alt="<?php echo esc_attr__( 'Brand logo', 'gmart-core' ) ?>">
										<?php if ( ! empty( $logo['link']['url'] ) ) : ?>
											</a>
										<?php endif; ?>
									<?php endif; ?>
